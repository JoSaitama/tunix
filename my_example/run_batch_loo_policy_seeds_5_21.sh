...
QUEUE_NAME="batch_loo_policy_seeds_5_21_${QUEUE_TS}"
...
METHODS=("batch_loo_policy" "batch_loo_policy")
SEEDS=(5 21)

echo "Queue: ${QUEUE_NAME}"
echo "Queue root: ${QUEUE_ROOT}"
echo "Runs: batch_loo_policy/5, batch_loo_policy/21"
...
printf '0\n' > "${QUEUE_ROOT}/exit_code"
echo
echo "Batch Policy-LOO seed 5/21 runs completed successfully."
