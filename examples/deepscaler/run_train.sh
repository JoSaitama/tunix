...
ACTOR_GENERATION_CHUNK_SIZE="${ACTOR_GENERATION_CHUNK_SIZE:-2}"
...
SAVE_INTERVAL_STEPS="${SAVE_INTERVAL_STEPS:-79}"
...
ACTOR_GENERATION_CHUNK_ARGS=()
if [[ -n "$ACTOR_GENERATION_CHUNK_SIZE" ]]; then
  ACTOR_GENERATION_CHUNK_ARGS=(
    --actor-generation-chunk-size "$ACTOR_GENERATION_CHUNK_SIZE"
  )
fi
