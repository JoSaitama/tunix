...
TUNIX_SWAP_ACTOR_ROLLOUT_MESHES="${TUNIX_SWAP_ACTOR_ROLLOUT_MESHES:-0}"
...
echo "  SWAP_ACTOR_ROLLOUT_MESHES=${TUNIX_SWAP_ACTOR_ROLLOUT_MESHES}"
...
run_worker() (
  ...
  export TUNIX_SWAP_ACTOR_ROLLOUT_MESHES
...
export TUNIX_SWAP_ACTOR_ROLLOUT_MESHES=${TUNIX_SWAP_ACTOR_ROLLOUT_MESHES@Q}
