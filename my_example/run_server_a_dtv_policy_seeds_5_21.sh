...
QUEUE_NAME="server_a_dtv_policy_seeds_5_21_${QUEUE_TS}"
...
echo "Runs: batch_policy/5, group_policy/5, batch_policy/21, group_policy/21"
...
printf '0\n' > "${QUEUE_ROOT}/exit_code"
echo
echo "All server A DTV-Policy seed 5/21 runs completed successfully."
