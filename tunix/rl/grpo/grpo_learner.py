    ...
    self.rl_cluster.actor_trainer.with_rl_metrics_to_log(
        {
            ...
            "loo_score_max": np.max,
            "loo_self_term_mean": np.mean,
            "loo_self_term_std": np.mean,
            "loo_cross_term_mean": np.mean,
            "loo_cross_term_std": np.mean,
            "loo_pre_cap_kept_samples": np.mean,
            "loo_post_cap_kept_samples": np.mean,
            "loo_pre_cap_kept_fraction": np.mean,
            "loo_post_cap_kept_fraction": np.mean,
            "loo_retention_cap_triggered": np.max,
            "loo_groups_with_cap_triggered": np.mean,
            "loo_groups_with_all_negative_scores": np.mean,
            "loo_min_group_kept_fraction": np.min,
            "loo_max_group_kept_fraction": np.max,
            "loo_optimizer_update_applied": np.sum,
            "loo_effective_update": np.sum,
            "loo_nonfinite_score_count": np.sum,
        }
    )
